                      ...
                      <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                          ...
                          <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="lassification.html" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              商品分類
                            </a>
            ...
            <div class="hole">
		        <div class='row'>
					  <div class='col-md-8 offset-md-2 text-center'>
					  	<h1>&emsp;&emsp;&emsp;&emsp;服飾專區</h1>
					  	<div class='row'>
            ...
            <div class="container">
              ...
              <div class='col-md-4 text-left'>
                          <div>
                            ...
                            <h2><img src='d:\11101year\system_analysis\test\img\icon\whale.png' width='45'>&emsp; 鯨魚會走路</h2>
                          </div>
