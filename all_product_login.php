            ...
            <div class="hole">
		        <div class='row'>
					  <div class='col-md-8 offset-md-2 text-center'>
					  	<h1>&emsp;&emsp;&emsp;&emsp;商品專區</h1>
					  	<div class='row'>
                            <div class='col-md-4_text-center'>
                <a href="#">
                  <img src='img\adv\bread.jpg'>
                </a>
                                <h5>老好吃的花生麵包，還不快來下單!</h5>
                            </div>
                            <div class='col-md-8 text-left'>
                                <p class='lead'></p>
                <h4>&emsp;&emsp;商品介紹</h4>
                                <p>台式麵包經典，古早味的「髒髒包」，翻炒過的雲林花生</p>
                <p>香脆可口，拌和進口鮮奶油後夾入傳統台式麵包，吃完一</p>
                <p>整個享受那份滿足花生奶油夾心麵包就是連接老中少三代</p>
                <p>的記憶橋樑。</p>
                            </div>
                        </div>
            </div>
        ...
        <div class='row'>
              <div class='col-md-8 offset-md-2 text-center'>
                <div class='row'>
                    <div class='col-md-4_text-center'>
        <a href="#">
          <img src='img\product\3c_product\clock.png'>
        </a>
                        <h5>恬靜木製鬧鐘，提升你的文藝氣息~</h5>
                    </div>
                    <div class='col-md-8 text-left'>
                        <p class='lead'></p>
        <h4>&emsp;&emsp;商品介紹</h4>
          <p>三段式亮度的護眼LED，</p>
          <p>聰明節電三組可設定不同時段的鬧鐘區分平日或假日響鈴，</p>
          <p>響鈴遠離手機輻射更貼心的照顧你的生活，</p>
          <p>更貼心的照顧你的生活。</p>
                    </div>
                </div>
    </div>
    ...
    <div class='row'>
          <div class='col-md-8 offset-md-2 text-center'>
            <div class='row'>
                <div class='col-md-4_text-center'>
    <a href="#">
      <img src='img\product\cloth\blakc.png'>
    </a>
                    <h5>凸顯個性，依然帥氣!</h5>
                </div>
                <div class='col-md-8 text-left'>
    ...
    <div class='row'>
          <div class='col-md-8 offset-md-2 text-center'>
            <div class='row'>
                <div class='col-md-4_text-center'>
    <a href="#">
      <img src='img\product\makeup\eye.jpg'>
    </a>
                    <h5>裸色深邃眼影</h5>
                </div>
                <div class='col-md-8 text-left'>
