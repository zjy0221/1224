        ...
        <header id="titimg">
	        <div class='container'>
				<nav class="navbar navbar-expand-lg navbar-light">
				  <a class="navbar-brand" href="main_screen.php"><h2 class="title">&nbsp;&nbsp;鯨魚會走路
                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                          ...
                          <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                              <li><a class="dropdown-item" href="classification.html">美食</a></li>
                              <li><a class="dropdown-item" href="life.html">生活用品</a></li>
                              <li><a class="dropdown-item" href="3c_product.html">3C產品</a></li>
                              <li><a class="dropdown-item" href="cloth.html">服飾</a></li>
                              <li><a class="dropdown-item" href="makeup.html">美妝</a></li>
                              <li><a class="dropdown-item" href="all_product.html">全部商品</a></li>
                            </ul>
                          </li>
                          <li class="nav-item">
                            ...
                            <div id="my-content">
                              <li class="menu__item">
                                <a href="登入頁面.php" class="menu__item-link">登入/註冊</a>
                              </li>
                          </div>
                        </ul>
        ...
        <section id ='intro'>
            <div class='jumbotron'> 
                <div class='container'>
                    ...
                    <a class='btn' href="註冊頁面.php">創建帳號</a>
                    </div>
                </div>
            </div>
        </section>
	        ...
	        <div class="container">
		        <div class='row'>
                      ...
                      <div class='col-md-4 text-left'>
                        <h4>連結</h4>
                        <ul>
                            <li><a href='main_screen.php'>主頁</a></li>
                            <li><a href='classification.html'>商品分類</a></li>
                        </ul>
                        <ul>
                            <li><a href='people.html'>個人專區</a></li>
