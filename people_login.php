    ...
    <header id="titimg">
        ...
        <section id='person'>
	        <div class="container">
                ...
                <div class="UID">(UID：<?php echo $_SESSION['uid']; ?>)</div>
            <div class="out" id="out"><a href="登出.php"><img src='img\icon\logout.png'></a></div>
        </section>
        <div class="br">
        </br>
       </div>
		        ...
		        <div class='row'>
                  ...
                  <div class='row'>
                      ...
                      <div class='col-md-3 text-left'>
                          <div class='outer'>
                                  <div class='upper'>
                                    <img src='img\button\content.png'>
                                  </div>
                              </a>
                          </div>
                      </div>
                      ...
                      <div class='col-md-3 text-left'>
                        <div class='outer'>
                                <div class='upper'>
                                  <img src='img\button\setting.png'>
                                  <div class='innertext'>
                                  </div>
                                </div>
                            </a>
		        ...
		        <div class='row'>
                  ...
                  <div class='row'>
                      <div class='col-md-6 text-left'>
                          <div class='outer'>
                                  <div class='upper'>
                                    <img src='img\button\finish_order.png'>
                                  </div>
                              </a>
                          </div>
                      </div>
              ...
              <div class='col-md-12 text-center'>
                <div class='row'>
                    ...
                    <div class='col-md-6 text-left'>
                        <div class='outer'>
                                <div class='upper'>
                                  <img src='img\button\my_like.png'>
                                </div>
